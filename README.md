...
A dated local default-batch sanity run with the streamed object reader scanned **8 repositories / 4,000 synthetic commits in about 0.09 s wall time** with about **11.6 MiB peak RSS** using 4 workers. It excludes network clone time and is not an SLA.
